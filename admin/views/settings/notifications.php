						...
						<tr>
							...
							<td>
								<?php if ( $notification['success'] ) : ?>
									<span class="notification-status-sent">✓ <?php esc_html_e( 'Sent', 'marketing-analytics-chat' ); ?></span>
								<?php else : ?>
									<span class="notification-status-failed">✗ <?php esc_html_e( 'Failed', 'marketing-analytics-chat' ); ?></span>
								<?php endif; ?>
							</td>
						</tr>
					<?php endforeach; ?>
