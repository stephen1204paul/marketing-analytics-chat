...
<div class="wrap marketing-analytics-chat-dashboard">
	...
	<div class="marketing-analytics-welcome">
		<h2><?php esc_html_e( 'Welcome to Marketing Analytics MCP', 'marketing-analytics-chat' ); ?></h2>
		<p><?php esc_html_e( 'Connect your marketing analytics platforms to expose data via Model Context Protocol for AI assistants like Claude.', 'marketing-analytics-chat' ); ?></p>
	</div>
	...
	<div class="marketing-analytics-chat-info">
		<h3><?php esc_html_e( 'MCP Server Configuration', 'marketing-analytics-chat' ); ?></h3>
		<p><?php esc_html_e( 'Use this endpoint URL to connect AI assistants via Model Context Protocol:', 'marketing-analytics-chat' ); ?></p>
		...
		<p class="description">
			...
			printf(
				...
				'<a href="https://github.com/yourusername/marketing-analytics-chat/blob/main/docs/setup-guides/" target="_blank">' . esc_html__( 'documentation', 'marketing-analytics-chat' ) . '</a>'
			);
			?>
		</p>
	</div>
	...
	<div class="marketing-analytics-getting-started">
		...
		<ol>
			<li><?php esc_html_e( 'Connect at least one analytics platform using the Connections page', 'marketing-analytics-chat' ); ?></li>
			<li><?php esc_html_e( 'Configure your AI assistant (e.g., Claude Desktop) to use the MCP endpoint above', 'marketing-analytics-chat' ); ?></li>
			<li><?php esc_html_e( 'Ask your AI assistant to analyze your marketing data', 'marketing-analytics-chat' ); ?></li>
		</ol>
	</div>
</div>
